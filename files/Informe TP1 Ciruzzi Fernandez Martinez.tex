...
\lstset{
	language=C, columns=flexible, breaklines=true, frame=single, title=Listing : proximo.h
}
\lstinputlisting{../src/proximo.h}
\lstset{
	title=Listing : main.c
}
\lstinputlisting{../src/main.c}
\lstset{
	title=Listing : proximo.c
}
...
\section{Resultados}
A continuación presentaremos los resultados de las corridas pedidas por los docentes de la materia.
\par ACA PONER LAS SALIDAS DE LOS .PBM
